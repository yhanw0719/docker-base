# Dockerfile for creating R container - base layer
# created and maintained by Yuhan Wang (yuhan_wang@berkeley.edu; yuhan_wang@lbl.gov)
# credit to Tin Ho (tin@lbl.gov) for his ATLAS dockerfile template and instructions
